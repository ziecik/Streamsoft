...
//  	List<CurrencyInfo> currencies = entity.getCurrencies();
	...
	public void addCurrency(String countryName, CurrencyCode code) {
		beginTransaction();
...
//	country.addCurrency(currencyInfo);
	...
	private Country getByName(String countryName) {
...
//    #4
	public List<Country> findCountriesWithTwoOrMoreCurrencies() {
		...
		String query = "select distinct c from Country c join fetch c. currencies where size(c.currencies) >= 2";
